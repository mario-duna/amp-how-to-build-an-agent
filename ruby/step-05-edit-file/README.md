...
| **Understand** | read_file | "How does main.rb work?" |
...
sequenceDiagram
    ...
    User->>Claude: "Fix the typo in main.rb"

    Claude->>Tools: list_files(".")
    Tools-->>Claude: [main.rb, ...]

    Claude->>Tools: read_file("main.rb")
...
```bash
mise run ruby:step-05
```

Try asking:
- "Create a hello.txt file with a greeting"
- "Add a comment to main.rb explaining what it does"
